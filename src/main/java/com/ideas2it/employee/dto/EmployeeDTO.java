...
public class EmployeeDTO {
	...
	public EmployeeDTO(int employeeId, String firstName, String lastName, String email, long phoneNumber, double salary,
			LocalDate dateOfJoining, List<AddressDTO> addresses, LocalDate dateOfBirth, String gender, String role,
	...
	public String toString() {
		...
		stringBuilder.append("\n\n**********Employee Details************ \n").append("\nEmployee Id          : ")
				...
				.append("\nDate Of Birth        : ").append(dateOfBirth).append("\nGender               : ")
				.append(gender).append("\nRole                 : ").append(role).append("\n       Address Details \n")
				.append(getAddresses()).append(getProjects());
