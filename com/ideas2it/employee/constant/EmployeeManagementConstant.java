...
public class EmployeeManagementConstant {
    ...
    public static final String EMPLOYEE_BLOODGROUP = "Enter the Employee Bloodgroup : ";
    public static final String EMPLOYEE_SALARY = "Enter the Employee salary : ";
